#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# Birth: 2022-09-17 23:55:22.574297732 +0530
# Modify: 2022-09-18 02:06:50.714207089 +0530
...
def main():
    ...
    parser.add_argument("-dtr", "--data_train", nargs="+", type=str,
                        default=["data/"],
                        help="Directory containing training embeds")
    parser.add_argument("-dts", "--data_test", nargs="+", type=str,
                        default=["data/"],
                        help="Directory containing test embeds")
    ...
    # Datasets
    train_dataset = MultiLabelDataset(data_paths=args.data_train,
                                      targets_paths=args.targets_paths,
                                      input_type="np")

    test_dataset = MultiLabelDataset(data_paths=args.data_test,
                                     targets_paths=args.targets_paths,
                                     input_type="np")
    ...
    model = EmbedMultiLabel(labels=train_dataset.unique_labels,
                            device=args.device,
