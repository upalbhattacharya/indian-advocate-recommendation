...
python train.py -d /DATA/upal/Datasets/DHC/variations/new/var_4/cross_val/0_fold/with_areas/ /DATA/upal/Datasets/SC_50k/variations/var_2/cross_val/0_fold/with_selected_areas/ \
