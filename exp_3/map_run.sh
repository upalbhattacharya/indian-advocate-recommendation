...
do
    ./map.py \
    -d ~/Results/advocate_recommendation/new/exp_3/cross_val/5_fold/fold_$i/results/scores.json \
    ...
    -o ~/Results/advocate_recommendation/new/exp_3/cross_val/5_fold/fold_$i/metrics/ \
    -l ~/Results/advocate_recommendation/new/exp_3/cross_val/5_fold/fold_$i/logs/ \
    -n map_hard
done
