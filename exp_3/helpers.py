...
def process(doc):
    """Takes a document and carries out lowercasing, removal of stopwords,
    lemmatization and proper POS tagging to be utilized for doc2vec"""
    ...
    # Returning a list containing the words of the passed document
    # after processing
    return text
