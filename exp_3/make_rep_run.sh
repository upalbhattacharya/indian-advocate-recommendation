...
do
    ./make_rep.py -f /home/workboots/Datasets/DHC/common_new/preprocess/fact_sentences/ \
        ...
        -m /home/workboots/Results/advocate_recommendation/new/exp_3/cross_val/5_fold/fold_$fold/model \
        -o /home/workboots/Results/advocate_recommendation/new/exp_3/cross_val/5_fold/fold_$fold/embeddings \
