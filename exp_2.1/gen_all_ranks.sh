...
do
    python calculate_ranks.py -d ~/Datasets/DHC/variations/new/var_1/cross_val/5_fold/fold_$fold/adv_split_info.json \
        ...
        -s ~/Results/advocate_recommendation/new/exp_2.1/cross_val/5_fold/fold_$fold/results/scores.json \
        -o ~/Results/advocate_recommendation/new/exp_2.1/cross_val/5_fold/fold_$fold/results/ \
