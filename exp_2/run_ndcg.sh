...
do
    ./ndcg.py --targets /home/workboots/Datasets/DHC/common/case_winners.json \
        ...
        --relevant_advocates /home/workboots/Datasets/DHC/common/selected_advs.json \
        --strategy 'equal' \
        --scores /home/workboots/Results/advocate_recommendation/exp_2/new_cross_val/20_fold/fold_$fold/scores.json \
        --output_path /home/workboots/Results/advocate_recommendation/exp_2/new_cross_val/20_fold/fold_$fold/ndcg_harder/ \
        # --threshold 1.0
done
