...
# -*- encoding: utf-8 -*-
# Birth: 2022-03-14 14:05:39.898443480 +0530
# Modify: 2022-03-14 15:30:55.025246987 +0530
...
def main():
    ...
    for case, ranks in scores.items():
        charge_iou[case] = {
                k: {
                    "iou": iou(case_charges[case], case_charges[k]),
                    "agreement": agreement(case_charges[case], case_charges[k])
                    }
                for k in ranks}
