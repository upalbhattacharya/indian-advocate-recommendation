...
do
    python calculate_ranks.py -d ~/Results/advocate_recommendation/exp_1_thresh_0.7/eval_embeddings/han_pred_DHC_SC_new_facts_fold_$fold/train/ \
        -q ~/Results/advocate_recommendation/exp_1_thresh_0.7/eval_embeddings/han_pred_DHC_SC_new_facts_fold_$fold/test/ \
