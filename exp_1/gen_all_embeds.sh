...
do
    ...
    -s ~/Results/advocate_recommendation/exp_1_thresh_0.7/eval_embeddings/han_pred_DHC_SC_new_facts_fold_$fold/train
    ...
    -ul ~/Datasets/DHC/variations/var_3/targets/unique_labels.txt \
    -s ~/Results/advocate_recommendation/exp_1_thresh_0.7/eval_embeddings/han_pred_DHC_SC_new_facts_fold_$fold/test
done
