...
do
    ./ndcg.py --targets /home/workboots/Datasets/DHC/common/case_winners.json \
        ...
        --relevant_advocates /home/workboots/Datasets/DHC/common/selected_advs.json \
        --strategy 'equal' \
        --scores /home/workboots/Results/advocate_recommendation/exp_1_thresh_0.7/metrics/han_pred_DHC_SC_new_facts_fold_$fold/similarity_reranking.json \
        --output_path /home/workboots/Results/advocate_recommendation/exp_1_thresh_0.7/metrics/han_pred_DHC_SC_new_facts_fold_$fold/ndcg_harder/ \
        # --threshold 1.0
done
