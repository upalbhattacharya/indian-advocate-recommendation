#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# Birth: 2022-09-13 09:37:05.879313858 +0530
# Modify: 2022-09-13 09:37:05.879313858 +0530

"""Training and evaluation for EnsembleConcatenation"""
...
from model.net import EnsembleConcatenation
...
def main():
    ...
    for path in args.embed_paths:
        train_paths.append(os.path.join(path, "train_rep"))
        test_paths.append(os.path.join(path, "test_rep"))

    # Datasets
    train_dataset = EnsembleDataset(embed_paths=train_paths,
                                    target_path=args.target_path)

    test_dataset = EnsembleDataset(embed_paths=test_paths,
                                   target_path=args.target_path)
    ...
    model = EnsembleConcatenation(proj_dim=params.proj_dim,
