...
do
    ./map.py \
    -d ~/Results/advocate_recommendation/new/exp_3.1/cross_val/5_fold/fold_$i/results/similarity_reranking.json \
    ...
    -o ~/Results/advocate_recommendation/new/exp_3.1/cross_val/5_fold/fold_$i/metrics/ \
    -l ~/Results/advocate_recommendation/new/exp_3.1/cross_val/5_fold/fold_$i/logs/ \
    -n map_hard
done
